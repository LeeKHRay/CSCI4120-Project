Shader "IndieChest/ForceShield" {
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			// multiply tex2D(_MainTex, i.uv_texcoord * _MainTex_ST.xy + _MainTex_ST.zw).rgba to show the hexagon grid
			// i.uv_texcoord * _MainTex_ST.xy + _MainTex_ST.zw is UV with tiliing and offset
			o.Albedo = Albedo.rgb * tex2D(_MainTex, i.uv_texcoord * _MainTex_ST.xy + _MainTex_ST.zw).rgba;
